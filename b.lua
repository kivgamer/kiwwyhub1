local placeId = game.PlaceId
	...
	if placeId == 2753915549 then --- Blox Fruit Old
		...
		if game.CoreGui:FindFirstChild("PC x Hub - Blox Fruit (Starter World)") then
			game.CoreGui:FindFirstChild("PC x Hub - Blox Fruit (Starter World)"):Destroy()
		end
...
do
	...
	function section:updateDropdown(dropdown, title, list, callback)
		...
		local L9s0 = library.new("PC x Hub - Blox Fruit (Starter World)")
			...
			[4442272183] = {
				...
				Welcome = function()
					return tostring(
						"<Color=White>Welcome " ..
							"<Color=Green>" ..
							game:GetService("Players").LocalPlayer.Name .. "!" .. " \n<Color=Yellow>To PC x Hub Script"
					)
				end
			}
		}
		...
		S9s05:addKeybind("Hide UI", Enum.KeyCode.RightControl, function()
			L9s0:toggle()
		end, function()
		...
		S9s08:addButton("Copy Link Discord",function()
			...
			setclipboard("https://discord.gg/gjW672mm")
		end)

		S9s08:addButton("Credit",function()

			L9s0:Notify("CREDIT ", "PC x HUB")
			wait(2.5)
			L9s0:Notify("CREDIT ", "PC x Hub")
		end)
	...
	if placeId == 4442272183 then --- Blox Fruit New World
		...
		if game.CoreGui:FindFirstChild("PC x Hub - Blox Fruit (New World)") then
			game.CoreGui:FindFirstChild("PC x Hub - Blox Fruit (New World)"):Destroy()
		end

		local library = loadstring(game:HttpGet("https://raw.githubusercontent.com/9s0/uif/main/README.md"))()

		local L9s0 = library.new("PC x Hub - Blox Fruit (New World)")
		...
		S9s03IIII:addToggle("Auto Raid Magma",false,function(value)
			local A_1 = "RaidsNpc"
			local A_2 = "Select"
			local A_3 = "Magma"
			local Event = game:GetService("ReplicatedStorage").Remotes["CommF_"]
		...
		S9s03IIII:addToggle("Auto Raid Buddha",false,function(value)
			local A_1 = "RaidsNpc"
			local A_2 = "Select"
			local A_3 = "Buddha"
			local Event = game:GetService("ReplicatedStorage").Remotes["CommF_"]
	...
	if placeId == 189707 then --- Natural Disaster Survival
		...
		if game.CoreGui:FindFirstChild("PC x Hub - Natural Disaster Survival") then
			game.CoreGui:FindFirstChild("PC x Hub - Natural Disaster Survival"):Destroy()
		end

		local library = loadstring(game:HttpGet("https://raw.githubusercontent.com/9s0/uif/main/README.md"))()

		local L9s0 = library.new("PC x Hub - Natural Disaster Survival")
...
local placeId = game.PlaceId
	if placeId == 7449423635 then --- Blox Fruit Old
...
do
	...
	function section:updateDropdown(dropdown, title, list, callback)
		...
		S9s07:addButton("ElectricClaw",function()
        local args = {
            [1] = "BuyElectricClaw"
        }
        game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer(unpack(args))
